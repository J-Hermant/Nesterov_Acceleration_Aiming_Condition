...
def build_nlp_model(exp_dict, ntokens):
    ...
    if exp_dict['model'] == 'Transformer_Small':
        nlp_model = model.TransformerModel(ntoken=ntokens, 
    ...
    elif exp_dict['model'] == 'Transformer_Medium' or exp_dict['model'] == 'Transformer':
        nlp_model = model.TransformerModel(ntoken=ntokens, 
                                       ninp=exp_dict['emsize'],
                                       nhead=4, 
                                       nhid=exp_dict['nhid'], 
